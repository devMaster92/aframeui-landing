...
export class MarkGoldenLayoutComponent extends React.Component {
  state = {};
  ...
  marketingGoldenLayoutInstance = undefined;

  componentDidMount() {
    this.marketingGoldenLayoutInstance = new GoldenLayout(
      this.props.config || {},
      this.containerRef.current
    );
    if (this.props.registerComponents instanceof Function)
      this.props.registerComponents(this.marketingGoldenLayoutInstance);
    this.marketingGoldenLayoutInstance.reactContainer = this;
    this.marketingGoldenLayoutInstance.init();
  }
}
...
class ReactComponentHandlerPatched extends ReactComponentHandler {
  _render() {
    var reactContainer = this._container.layoutManager.reactContainer; //Instance of MarkGoldenLayoutComponent class
