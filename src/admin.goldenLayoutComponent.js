...
export class AdminGoldenLayoutComponent extends React.Component {
  state = {};
  ...
  adminGoldenLayoutInstance = undefined;

  componentDidMount() {
    this.adminGoldenLayoutInstance = new GoldenLayout(
      this.props.config || {},
      this.containerRef.current
    );
    if (this.props.registerComponents instanceof Function)
      this.props.registerComponents(this.adminGoldenLayoutInstance);
    this.adminGoldenLayoutInstance.reactContainer = this;
    this.adminGoldenLayoutInstance.init();
  }
}
...
class ReactComponentHandlerPatched extends ReactComponentHandler {
  _render() {
    var reactContainer = this._container.layoutManager.reactContainer; //Instance of AdminGoldenLayoutComponent class
